        ...
        public static string GetAnswerToMessage(string message, bool isNewUser = false, Int64 userId = 0)
        {
            ...
            else if (message == "/rules" || message == "/r")
            {
                return "\U00002753*Как играть:*\U00002753\r\n\r\n" +
                    ...
                    "_•Успешное нахождение бесполезных файлов или шифровшика Чисткой реестра_. *(+2S)*\r\n" +
                    "_•Отправка себя бесполезных файлов или использование Антивируса_. *(+1S)*\r\n" +
                    "_•Успешное получение данных от Шифровщика_. *(+1S)*\r\n\r\n" +
